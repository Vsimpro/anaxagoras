"""
*
*   This is the original gitlab actions monitoring tool,
*   with the changes from (axedos/preloadedso).
*
*   It still runs standalone, but to better incorporate it
*   into the kit/repository there's a git_actions.py
*   that can be run as a thread along side other scrapers.
*   -Vs1m, 2026
*
"""
...
if __name__ == "__main__":
    ...
    #TODO: get this from .env and use appriser
    parser.add_argument(
        "-w", "--webhook",
        required= True,
    ...
    # Specify a file with username permutations
    parser.add_argument(
        "-f", "--userfile",
        required = True,
