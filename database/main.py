"""
SQLite wrapper for the database.
"""
import sqlite3
...
def create_tables(tables) -> bool:
    ...
    try:
        for table_name in tables:
            ...
            table_in_database_query = query_database(
...
def insert_data(query: str, data) -> bool:
    ...
    try:
        ...
        CONNECTION.rollback()
        print(f"[SQLITE][x] Tried to insert duplicate or invalid constrained value: ", ie)
        return 0
...
def initialize_db(tables, db_path : str = "database.db") -> bool:
    """
    Prepare the SQLite Database for use.
